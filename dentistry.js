$(document).ready(function() {
    ...
    $('.interactive-tooth').on('mouseenter', function(event) {
        ...
        // Animate the text inside the tooltip to create a scrolling effect
        ...
        function startMarquee() {
            // Reset the position of the text to the right end of the container
            span.css({
    ...
    $('.interactive-tooth').on('mousemove', function(event) {
        ...
        // Update position of tooltip to stay centered on the cursor
        tooltip.css({
            top: event.pageY - (tooltipHeight / 2) + 'px',
            left: event.pageX - (tooltipWidth / 2) + 'px'
        });
